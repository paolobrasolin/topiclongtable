...
\int_new:N \TopCol
  ...
  % se nuovo o diverso
  %   appendi elemento 1
  % altrimenti è uguale, quindi
%   aumenta ultimo elemento di 1
...
%% \cs_new:Npn \GetFile #1 {
%%   \iow_new:N \l_my_stream
%%   \ior_open:Nn \l_my_stream {seed2.topicstables}
...
%% \cs_new:Npn \SetFile #1 {
%%   \iow_new:N \l_my_stream
%%   \iow_open:Nn \l_my_stream {seed2.topicstables}

%%   \iow_now:Nn  \l_my_stream {really \relax \expandme}
%%   \iow_now:Nx  \l_my_stream {really \relax \expandme}
%%   \iow_now:Nx  \l_my_stream {really \relax \noexpand\expandme}
...
\NewDocumentCommand{\TLine}{}{%
  \int_gset:Nn \TopCol {0}
  %% \setcounter{TopCol}{1}%\stepcounter{TopRow}
}

\NewDocumentCommand{\Tcline}{}{%
}
...
\begin{longtable}{|Tl|Tl|Tl|Tl|}                      
 \Tcline{4} \Topic[T1] & \Topic[ST1] & \Topic[SST1] & A \TLine\\ 
 \Tcline{4} \Topic     & \Topic      & \Topic[SST2] & B \TLine\\ 
 \Tcline{4} \Topic     & \Topic[ST2] & \Topic[SST3] & C \TLine\\ 
 \Tcline{4} \Topic[T2] & \Topic[ST3] & \Topic[SST4] & D \TLine\\ 
 \Tcline{4} \Topic     & \Topic[ST4] & \Topic[SST5] & E \TLine\\ 
 \Tcline{4} \Topic     & \Topic      & \Topic       & F \TLine\\
 \Tcline{4} \Topic     & \Topic[ST5] & \Topic[SST6] & F \TLine\\
 \hline
\end{longtable}
